...
public class PdfCreator {
    ...
    public static void generateInvoice(Invoice invoice){
        ...
        try {
            String pathToPdf = invoice.getContactID() + "_invoice-" + invoice.getInvoiceID() + ".pdf";
    ...
    private static void addInvoiceInfo(Invoice invoice, Document pdf) throws DocumentException {
        ...
        pdf.add(new Paragraph("Contact: " + ((invoice.getContactID() != null) ? invoice.getContactID().toString() : ""), font));
