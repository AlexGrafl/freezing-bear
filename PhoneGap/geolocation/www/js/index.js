 //Location content element
  ...
  function onLocationSuccess(loc) {
	...
	//localStorage.setItem('lastLocation', data);
	window.localStorage.setItem('lastLocation', jsonLoc);
	

  }
  
  function writeLocationToUI(loc)
  {
  ...
  {
	//var lastLoc = JSON.parse(localStorage.getItem('lastLocation'));
	var lastLoc = JSON.parse(window.localStorage.getItem('lastLocation'));
	
	writeLocationToUI(lastLoc)
  }
